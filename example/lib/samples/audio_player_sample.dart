        ...
        children: <Widget>[
          Align(
            ...
            child: NeumorphicButton(
              ...
              child: Icon(Icons.navigate_before, color: _iconsColor()),
            ),
          ),
          Align(
            alignment: Alignment.center,
            child: Text('Now Playing', style: TextStyle(color: NeumorphicTheme.defaultTextColor(context))),
          ),
          Align(
  ...
  Widget _buildTitle(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        Text(
          'Blinding Lights',
          style: TextStyle(fontWeight: FontWeight.w800, fontSize: 34, color: NeumorphicTheme.defaultTextColor(context)),
        ),
        const SizedBox(height: 4),
        Text(
          'The Weeknd',
          style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14, color: NeumorphicTheme.defaultTextColor(context)),
        ),
      ],
    );
  }
        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              Align(
                alignment: Alignment.centerLeft,
                child: Text('2.00', style: TextStyle(color: NeumorphicTheme.defaultTextColor(context))),
              ),
              Align(
                alignment: Alignment.centerRight,
                child: Text('3.14', style: TextStyle(color: NeumorphicTheme.defaultTextColor(context))),
              ),
            ],
          ),
          const SizedBox(height: 8),
          NeumorphicSlider(height: 8, min: 0, max: 314, value: 100, onChanged: (value) {}),
        ],
      ),
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        NeumorphicButton(
          ...
          onPressed: () {},
          style: const NeumorphicStyle(shape: NeumorphicSurfaceType.flat, boxShape: NeumorphicBoxShape.circle()),
          child: Icon(Icons.skip_previous, color: _iconsColor()),
        ),
        ...
        NeumorphicButton(
          ...
          onPressed: () {},
          style: const NeumorphicStyle(shape: NeumorphicSurfaceType.flat, boxShape: NeumorphicBoxShape.circle()),
          child: Icon(Icons.play_arrow, size: 42, color: _iconsColor()),
        ),
        const SizedBox(width: 12),
        NeumorphicButton(
          padding: const EdgeInsets.all(18.0),
          onPressed: () {},
          style: const NeumorphicStyle(shape: NeumorphicSurfaceType.flat, boxShape: NeumorphicBoxShape.circle()),
          child: Icon(Icons.skip_next, color: _iconsColor()),
        ),
      ],
    );
  }
