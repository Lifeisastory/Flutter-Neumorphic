...
class _PageState extends State<_Page> {
  ...
  Widget build(BuildContext context) {
    return NeumorphicBackground(
      ...
      child: Scaffold(
        appBar: const TopBar(title: 'Checkbox', actions: <Widget>[ThemeConfigurator()]),
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [_DefaultWidget(), _ColorWidget(), _EnabledDisabledWidget(), const SizedBox(height: 30)],
          ),
        ),
      ),
    );
...
class _ColorWidgetState extends State<_ColorWidget> {
  ...
  Widget _buildWidget(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          Text('Colorizable', style: TextStyle(color: NeumorphicTheme.defaultTextColor(context))),
          const SizedBox(width: 12),
          ColorSelector(
            color: customColor,
