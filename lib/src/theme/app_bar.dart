...
class NeumorphicAppBarIcons {
  ...
  const NeumorphicAppBarIcons({this.menuIcon = const Icon(Icons.menu), this.closeIcon = const Icon(Icons.close), Icon? backIcon, Icon? forwardIcon})
      : _backIcon = backIcon,
  ...
  NeumorphicAppBarIcons copyWith({Icon? backIcon, Icon? closeIcon, Icon? menuIcon, Icon? forwardIcon}) {
